...
public class XanderClimbSubsystem {
    ...
    private static DoubleSolenoid firstClaw = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, 1, 2);
    private static DoubleSolenoid secondClaw = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, 1, 2);
