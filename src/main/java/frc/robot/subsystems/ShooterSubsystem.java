...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public void setAngle(double radians) {
        ...
        if (radians < HOOD_MIN_ANGLE) {
            ...
            // hoodMotor.set(ControlMode.Position, HOOD_RATIO * (HOOD_MAX_ANGLE -
            // HOOD_MIN_ANGLE) / FALCON_TICKS);
            // SmartDashboard.putNumber("Hood angle", HOOD_MAX_ANGLE / DEG);
        } else {
            // hoodMotor.set(ControlMode.Position, HOOD_RATIO * (radians * RAD -
            // HOOD_MIN_ANGLE) / FALCON_TICKS);
     ...
     * 
     * <p>
     * WARNING: Calling this method does not prevent other methods from using
